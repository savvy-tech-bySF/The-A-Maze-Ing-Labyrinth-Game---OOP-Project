...
void Board::initializeBoard() 
{
    ...
    Coordinates c(54, 50); FixedMaze yellowBase(c); yellowBase.setID("0"); yellowBase.setType(corner); yellowBase.setTreasure(none);FM.push_back(yellowBase);
    Coordinates d(214, 210); FixedMaze Books(d); Books.setID("1"); Books.setType(three_sided); Books.setTreasure(books);FM.push_back(Books);
    ...
    Coordinates g(54, 50); FixedMaze Map(g); Map.setID("4"); Map.setType(three_sided); Map.setTreasure(map);FM.push_back(Map);
    Coordinates h(214, 210); FixedMaze Crown(h); Crown.setID("5"); Crown.setType(three_sided); Crown.setTreasure(crown);FM.push_back(Crown);
    ...
    Coordinates k(54, 50); FixedMaze Ring(k); Ring.setID("8"); Ring.setType(three_sided); Ring.setTreasure(ring);FM.push_back(Ring);
    Coordinates l(214, 210); FixedMaze Chest(l); Chest.setID("9"); Chest.setType(three_sided); Chest.setTreasure(treasure_chest);FM.push_back(Chest);
    ...
    Coordinates o(54, 50); FixedMaze greenBase(o); greenBase.setID("12"); greenBase.setType(corner); greenBase.setTreasure(none);FM.push_back(greenBase);
    Coordinates p(214, 210); FixedMaze Candles(p); Candles.setID("13"); Candles.setType(three_sided); Candles.setTreasure(candles);FM.push_back(Candles);
    ...
    Coordinates t(274,50); MazeCards check2(t); check2.setID("17"); check2.setType(line); check2.setTreasure(none); check2.setOrientation("SE"); check2.src = {755, 335, 411, 411}; check2.move = {check2.coords.x, check2.coords.y, 80, 80};
